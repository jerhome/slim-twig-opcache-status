...
function set_text(t) {
    if (t === "memory") {
        d3.select("#stats").html(
            "<table><tr><th style='background:#B41F1F;'>Used</th><td>"+HumanUsedMemory+"</td></tr>"+
            "<tr><th style='background:#1FB437;'>Free</th><td>"+HumanFreeMemory+"</td></tr>"+
            "<tr><th style='background:#ff7f0e;' rowspan=\"2\">Wasted</th><td>"+HumanWastedMemory+"</td></tr>"+
            "<tr><td>"+WastedMemoryPercentage+"%</td></tr></table>"
        );
    } else if (t === "keys") {
        d3.select("#stats").html(
